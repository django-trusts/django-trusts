"""Historical concrete django-trusts implementation (Zero add-on).

Settings constants used by models and historical migrations live here,
not on kernel ``trusts/__init__.py``. Django app label remains ``trusts``.
"""
