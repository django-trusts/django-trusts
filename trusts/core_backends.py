"""Generic Trusts backend mixin and default plan-compiler wiring.

Canonical public import for ``TrustModelBackendMixin``. Historical
``trusts.backends.TrustModelBackendMixin`` is a deprecated alias of this
exact object. Historical group SQL and its compiler stay on
