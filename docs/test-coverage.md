...
- `DefaultConfiguredModelContractTest` — issue #26 default-model regression: Role / TrustUserPermission / TrustGroup FKs use auth models; mismatched permission instances are not coerced by PK; `trusts.E003`–`E005` do not fire
